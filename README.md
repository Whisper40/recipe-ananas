...
- Import local du texte de plusieurs captures Instagram par OCR, sans traduction, avec suppression automatique des hashtags et prévisualisation avant insertion.
...
- Choix du canal de mises à jour : Stable utilise la release GitHub marquée latest, Beta utilise la release publiée de version la plus élevée, y compris les pre-releases.
